          ...
          {navItems.map((item) => (
            ...
            >
              <a
                ...
                className='flex items-center gap-2 px-4 py-2 rounded-full text-sm text-foreground/80 hover:text-foreground hover:bg-foreground/10 transition-colors cursor-pointer'
              >
